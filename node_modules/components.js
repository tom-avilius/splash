...
class SplashMainWindow {
    ...
    constructor() {
        ...
        this.mainWindowConfig = {
            ...
            height: 4096, //high value to counter all screens full-screen
            width: 4096,  //high value to counter all screens full-screen 
            frame: false,
    ...
    start() {
        ...
        app.whenReady().then( () => {
            ...
            const mainWindow = new BrowserWindow(this.mainWindowConfig);
